...
public class NewHistorial extends AppCompatActivity {
    ...
    public void postEnfermedad(String datos){
        ...
        client.post(getApplicationContext(),"http://192.168.100.7:64698/api/EnfermedadxPersona/PostEnfermedadxPersona",entity,"application/json",new AsyncHttpResponseHandler(){
            @Override
    ...
    public void GetEnfermedades(){
        ...
        AsyncHttpClient client = new AsyncHttpClient();
        client.get("http://192.168.100.7:64698/api/Enfermedad/GetAllEnfermedades",params,new AsyncHttpResponseHandler(){
            @Override
            public void onSuccess(String response){
